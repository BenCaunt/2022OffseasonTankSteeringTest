...
public class ControlConstants {
	...
	public static SqrtCoefficients angleControl2 = new SqrtCoefficients(0.45, 0.05,0);
	...
	public static WPILibMotionProfile.Constraints angularConstraints =
			new WPILibMotionProfile.Constraints(Math.toRadians(300), Math.toRadians(300));


	public static MotionConstraint driveConstraintsNew = new MotionConstraint(90,-30,60);
